...
public class Nutricionista {
    ...
    @jakarta.validation.constraints.Size(min = 2, max = 100, message = "El nombre debe tener entre 2 y 100 caracteres")
    ...
    @jakarta.validation.constraints.Size(min = 2, max = 100, message = "El apellido debe tener entre 2 y 100 caracteres")
    ...
    @NotBlank(message = "Debes definir el activo obligatoriamente")
    ...
    public void addPaciente(Paciente paciente) {
        pacientes.add(paciente); // lo agrego a la lista
    }

    // Usar @JsonIgnoreProperties:
